...
<body>
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-amount-summary">
                ...
                <div class="checkout-btn mt-100">
                    <a href="./index.php" class="btn essence-btn">Commander</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- ##### Welcome Area Start ##### -->
    <section class="welcome_area bg-img background-overlay" style="background-image: url(./img/plant-background.jpg);">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="hero-content">
                        ...
                        <a href="./allproducts.php" class="btn essence-btn">Voir nos produits</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(./img/products/plantes/absynth.jpg);">
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(./img/products/encens/Djaoui.jpg);">
                        <div class="catagory-content">
                            <a href="#">Encens</a>
                        </div>
                    </div>
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(./img/products/resines/resine.jpg);">
                        <div class="catagory-content">
                            <a href="#">Résines</a>
                        </div>
                    </div>
                        ...
                        <div class="single-product-wrapper">
                           Product Image 
                            <div class="product-img">
                                <img src="img/images/absynth.jpg" alt="image de l'absinthe">
                             Hover Thumb
                                <img class="hover-img" src="img/images/anis-vert.jpg" alt="image">
                                 Favourite
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description">
                                ...
                                <div class="hover-content">
                                     Add to Cart
                                    <div class="add-to-cart-btn">
                                        <a href="./includes/panier.php" class="btn essence-btn">Ajouter au panier</a>
                                    </div>
                                </div>
                            </div>
                        </div>
